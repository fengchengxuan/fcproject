                ...
                <table class="artable">
                    ...
                    <th style="width: 97px;border-left: 1px solid #24a1e4">
                        <div class="select_model">
                            <div class="Selected" id="Selected"><span>新闻快报</span>&nbsp;<img src=${ctx}/static/background/images/adm_icon.png alt="下拉"></div>
                    ...
                    <th style="width: 119px;border-left: 1px solid #24a1e4">
                        <div class="select_model">
                            <div class="Selected" id="Selected3"><span>草稿</span>&nbsp;<img src=${ctx}/static/background/images/adm_icon.png alt="下拉"></div>
