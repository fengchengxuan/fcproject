...
//                document.getElementById("container").value = body;
        ...
        $("#Preservation").click(function(){
            ...
            $.ajax({
                url : url,
                type : 'POST',
                data : "htmlText="+htmlText+"&title="+newsTitle+"&key="+newsKey+"&abstract1="+newsAbstract+"&type="+newsType+"&status=草稿",
                async:true,
                cache:false,
                dataType : 'json',
    ...
    $("#Submit").click(function(){
        ...
        $.ajax({
            url : url,
            type : 'POST',
            data : "htmlText="+htmlText+"&title="+newsTitle+"&key="+newsKey+"&abstract1="+newsAbstract+"&type="+newsType+"&status=正常",
            async:true,
            cache:false,
            dataType : 'json',
            success : function(data){
