...
<div class="contener" style="overflow: hidden">
    ...
    <div class="admlistbox">
        ...
        <div class="admbtnbox">
            ...
            <button class="del" id="reset-show" onclick="resetshow()">删除</button>
        </div>
        <div class="pages">
...
<%--删除提示--%>
<div id="reset-p1" style="width: 100%; height: 100%; background: rgba(0, 0, 0, 0.3); position: fixed; top: 0; left: 0;">
    <div style="width: 476px;height: 427px;background:white;position: fixed;top: 28%;left: 40%;border-radius: 4px">
        ...
        <button id="reset-hide" onclick="resethi()" style="width: 128px;height: 36px; border: 1px solid #ccc;margin: 28px 0 0 85px;background: #fff;border-radius: 2px">取消删除</button>
...
//-------------------------------------------------------删除
    ...
    function resethi()
    {
        ...
        var mychar = document.getElementById("reset-p1").style.display ="none";
    ...
    function resetshow()
    {
        ...
        var mychar = document.getElementById("reset-p1").style.display ="block";
